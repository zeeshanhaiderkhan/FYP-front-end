...
function DietPlans(){
    ...
    return(
       ...
       <div class="container">
        <Row>
            <TableOptionsCustom button={<CustomModalComp title={<IconCustom icon={<FcPlus/>} size="3em" />} heading="Add New Diet Plan" body={<DietPlanUploadForm/>} /> } />
      </Row>
    </div>
        <TableWrapper 
...
function DietPlanUploadForm(){

    return(
        <>
            <FormControl type="Text" placeholder="Diet Plan Title" style={{margin:5}}/>
