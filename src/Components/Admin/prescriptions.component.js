...
function Prescriptions(){
    ...
    return(
       ...
       <div class="container">
        <Row>
            <TableOptionsCustom button={<CustomModalComp title={<IconCustom icon={<FcPlus/>} size="3em" />} heading="Add New Prescription" body={<PrescriptionUploadForm/>} /> } />
      </Row>
    </div>
        <TableWrapper 
...
function PrescriptionUploadForm(){
    ...
    return(
        <>
            <FormControl type="Text" placeholder="Prescription Title" style={{margin:5}}/>
